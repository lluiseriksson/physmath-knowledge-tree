...
const errors = [];
const pages = ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html', 'formalization.html', 'dossiers.html', 'runs.html', 'capsules.html', 'offline.html', '404.html'];
