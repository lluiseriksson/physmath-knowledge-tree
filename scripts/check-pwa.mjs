...
ensure(shortcutUrls.has('./') && shortcutUrls.has('./learning.html') && shortcutUrls.has('./workbench.html') && shortcutUrls.has('./evidence.html') && shortcutUrls.has('./changes.html'), 'Manifest needs shortcuts for research, learning, workbench, evidence and change-review surfaces');
...
for (const page of ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html', 'offline.html']) {
