...
ensure(shortcutUrls.has('./') && shortcutUrls.has('./learning.html') && shortcutUrls.has('./workbench.html') && shortcutUrls.has('./evidence.html') && shortcutUrls.has('./changes.html') && shortcutUrls.has('./formalization.html') && shortcutUrls.has('./dossiers.html') && shortcutUrls.has('./runs.html') && shortcutUrls.has('./capsules.html'), 'Manifest needs shortcuts for research, learning, workbench, evidence, change-review, Lean-audit, dossier, run-ledger and capsule surfaces');
...
for (const page of ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html', 'formalization.html', 'dossiers.html', 'runs.html', 'capsules.html', 'offline.html']) {
