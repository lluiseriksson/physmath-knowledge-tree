...
ensure(shortcutUrls.has('./') && shortcutUrls.has('./learning.html') && shortcutUrls.has('./workbench.html') && shortcutUrls.has('./evidence.html'), 'Manifest needs shortcuts for research, learning, workbench and evidence surfaces');
...
for (const page of ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'offline.html']) {
