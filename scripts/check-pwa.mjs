...
ensure(shortcutUrls.has('./') && shortcutUrls.has('./learning.html') && shortcutUrls.has('./workbench.html') && shortcutUrls.has('./evidence.html') && shortcutUrls.has('./changes.html') && shortcutUrls.has('./formalization.html') && shortcutUrls.has('./dossiers.html') && shortcutUrls.has('./runs.html'), 'Manifest needs shortcuts for research, learning, workbench, evidence, change-review, Lean-audit and dossier and run-ledger surfaces');
...
for (const page of ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html', 'formalization.html', 'dossiers.html', 'runs.html', 'offline.html']) {
