...
const pages = ['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html', '404.html', 'offline.html'];
const errors = [];
...
for (const page of pages) {
  ...
  if (['index.html', 'learning.html', 'workbench.html', 'evidence.html', 'changes.html'].includes(page) && !/<a\b[^>]*class=(?:"[^"]*skip-link| '[^']*skip-link)/i.test(html)) {
