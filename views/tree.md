...
- **Foundations, logic and type theory** `domain.foundation_logic`
  - **Category theory** `domain.category_theory`
    - **Algebra** `domain.algebra`
      - **Representation theory** `domain.representation_theory`
        - **Automorphic forms** `domain.automorphic_forms`
    - **Algebraic geometry** `domain.algebraic_geometry`
      - **Arithmetic geometry** `domain.arithmetic_geometry`
        - **Birch and Swinnerton-Dyer Conjecture** `problem.birch_swinnerton_dyer`
...
- **Topology** `domain.topology`
  - **Differential geometry** `domain.differential_geometry`
    - **Gauge theory** `domain.gauge_theory`
    - **General relativity** `domain.general_relativity`
    - **Poincare Conjecture** `problem.poincare_conjecture`
